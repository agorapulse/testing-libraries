...
.Example Specification
----
include::../office-unit/src/test/groovy/com/agorapulse/officeunit/OfficeUnitSpec.groovy[tag=differences]

include::../office-unit/src/test/groovy/com/agorapulse/officeunit/OfficeUnitSpec.groovy[tag=differences-count]

include::../office-unit/src/test/groovy/com/agorapulse/officeunit/OfficeUnitSpec.groovy[tag=ignore]
----
