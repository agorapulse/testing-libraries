...
Set of useful test utilities. All the libraries are available in https://central.sonatype.com/search?q=g%3Acom.agorapulse.testing[Maven Central].
...
Grails Job Testing Support has been discontinued since
